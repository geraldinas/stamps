# Description
### The objective of this app is to create a simple playful single page app built with no libraries. Uses plain Javasctipt, Html, CSS. Images are original Cats created by myself originally created for a silkscreen project.
# NOTES
  *  getRandomImage(); Returns a random image URL from the stamps array.
